...
Cross-repo initiative state. Read `summary.md` first, then supporting files as needed.

| Initiative | Read when | Status |
|---|---|---|
| `elmo-chat` | Working on ELMO Chat / FinAI — BFF, agentgateway, chat panel, Orchestrator, Fin, Kore.ai replacement | Active — M1 end Aug |
